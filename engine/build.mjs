...
const args = [
  ...
  "-sEXPORTED_FUNCTIONS=_main,_qjs_init,_qjs_bundle_id,_qjs_begin,_qjs_step,_qjs_set_yield_floor,_qjs_top_weight,_qjs_pending,_qjs_chunks,_qjs_provide,_qjs_finalize,_qjs_teardown,_malloc,_free",
  "-sNODERAWFS=0",
  "-o", join(OUT, "qjs.mjs"),
];
