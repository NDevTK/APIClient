/* PerformanceObserver — Blink core/timing. A faithful hand implementation: the callback never fires from a real intersection/
 ...
 * generic noop stub. The canonical PerformanceObserver IDL AUDITS this for missing members (idlgen), not generates stubs. */
