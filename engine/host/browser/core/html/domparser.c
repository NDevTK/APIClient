                                              ...
                                              JSValueConst *argv, int magic)
{
    ...
    if (strcmp(type, "text/html") != 0) {
        ...
        DFAIL("HTML §8.5.1 parseFromString reached its XML arm and this build has no XML parser (lexbor ships "
              ...
              "xml_ref.h is §4.1's [66] CharRef and [68] EntityRef with §4.6's five predefined entities, and "
              ...
              "[18] CDSect, and §3.3.3 attribute-value normalization over [10] AttValue, which is written over "
