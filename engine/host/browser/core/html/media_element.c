...
static const JSCFunctionListEntry MEDIA_CONSTS[] = {
    JS_PROP_INT32_DEF("NETWORK_EMPTY", NETWORK_EMPTY, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("NETWORK_IDLE", NETWORK_IDLE, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("NETWORK_LOADING", NETWORK_LOADING, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("NETWORK_NO_SOURCE", NETWORK_NO_SOURCE, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("HAVE_NOTHING", HAVE_NOTHING, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("HAVE_METADATA", HAVE_METADATA, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("HAVE_CURRENT_DATA", HAVE_CURRENT_DATA, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("HAVE_FUTURE_DATA", HAVE_FUTURE_DATA, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("HAVE_ENOUGH_DATA", HAVE_ENOUGH_DATA, IDL_CONSTANT_PROP_FLAGS),
};

static const JSCFunctionListEntry ERROR_CONSTS[] = {
    JS_PROP_INT32_DEF("MEDIA_ERR_ABORTED", MEDIA_ERR_ABORTED, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("MEDIA_ERR_NETWORK", MEDIA_ERR_NETWORK, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("MEDIA_ERR_DECODE", MEDIA_ERR_DECODE, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("MEDIA_ERR_SRC_NOT_SUPPORTED", MEDIA_ERR_SRC_NOT_SUPPORTED, IDL_CONSTANT_PROP_FLAGS),
};
