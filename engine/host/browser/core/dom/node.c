...
static const JSCFunctionListEntry js_node_consts[] = {
    JS_PROP_INT32_DEF("ELEMENT_NODE", 1, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("ATTRIBUTE_NODE", 2, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("TEXT_NODE", 3, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("CDATA_SECTION_NODE", 4, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("ENTITY_REFERENCE_NODE", 5, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("ENTITY_NODE", 6, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("PROCESSING_INSTRUCTION_NODE", 7, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("COMMENT_NODE", 8, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_NODE", 9, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_TYPE_NODE", 10, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_FRAGMENT_NODE", 11, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("NOTATION_NODE", 12, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_DISCONNECTED", NODE_POS_DISCONNECTED, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_PRECEDING", NODE_POS_PRECEDING, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_FOLLOWING", NODE_POS_FOLLOWING, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_CONTAINS", NODE_POS_CONTAINS, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_CONTAINED_BY", NODE_POS_CONTAINED_BY, IDL_CONSTANT_PROP_FLAGS),
    JS_PROP_INT32_DEF("DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC", NODE_POS_IMPLEMENTATION_SPECIFIC, IDL_CONSTANT_PROP_FLAGS),
};
