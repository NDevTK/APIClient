...
/* HOW MANY ENTRIES THE MAP HOLDS AT ALL — an O(1) PRECONDITION and never a census. `attr_shadow_find` is a
   ...
   any slot" — never "this element's attribute is concrete", which is `attr_shadow_find`'s question. */
int attr_shadow_count(void);
