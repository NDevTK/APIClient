export const __rspack_esm_id=7938;export const __rspack_esm_ids=[7938];export const __webpack_modules__={56706(e,t,n){var a=n(22009),s=n(31601),o=n.n(s),i=n(76314),r=(n.n(i))()(o());r.push([e.id,".content-feedback{border:none;margin:0 0 .25rem;padding:0}.content-feedback>label{display:block;margin-bottom:.25rem}.content-feedback .thank-you{display:block;margin-bottom:calc(2.75rem + 2px)}.content-feedback mdn-button{flex:1;min-width:0}.content-feedback--buttons{display:inline-flex;gap:.75rem;margin:.25rem 0}.content-feedback--radios{align-items:center;display:flex;gap:.25rem;margin:.25rem 0}",""]);let c=(0,a.AH)([r.toString()]);n.d(t,{},{A:c})},65929(e,t,n){n.r(t),n.d(t,{MDNContentFeedback:()=>MDNContentFeedback}),n(35268);var a=n(22009),s=n(70693),o=n(23727);let i=(0,a.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M17 14V2M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88"/></svg>`,r=(0,a.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M7 10v12m8-16.12L14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88"/></svg>`;var c=n(56706);let MDNContentFeedback=class MDNContentFeedback extends(0,s.J)(a.WF){static styles=c.A;static get properties(){return{locale:{type:String},_reason:{state:!0},_view:{state:!0}}}constructor(){super(),this.locale="",this._reason="",this._view="vote"}_handleVote({target:e}){if(e instanceof HTMLElement){let t=e.dataset.vote;"yes"===t?this._view="thanks":"no"===t&&(this._view="feedback"),(0,o.w)(`thumbs: article-footer -> ${"yes"===t?"1":"0"}`)}}_handleFeedback(){this._view="thanks",(0,o.w)(`article_footer: feedback -> ${this._reason}`)}_getFeedbackReasons(){return"de"===this.locale?[{key:"technical",label:"Übersetzung enthält fachliche Fehler"},{key:"consistency",label:"Begriffe sind inkonsistent übersetzt"},{key:"incomprehensible",label:"Übersetzung ist nicht verständlich"},{key:"linguistic",label:"Übersetzung enthält sprachliche Fehler"},{key:"code_examples",label:"Code-Beispiele funktionieren nicht"},{key:"other",label:"Sonstige"}]:[{key:"outdated",label:this.l10n("content-feedback-content-is-out-of-date")`Content is out of date`},{key:"incomplete",label:this.l10n("content-feedback-missing-information")`Missing information`},{key:"code_examples",label:this.l10n("content-feedback-code-examples-not-working-as-exp")`Code examples not working as expected`},{key:"other",label:this.l10n("content-feedback-other")`Other`}]}_renderVote(){return(0,a.qy)`<label
      ...
      </div>`}_renderThanks(){return(0,a.qy)`<span class="thank-you">
    ...
    </fieldset>`}};customElements.define("mdn-content-feedback",MDNContentFeedback)}};
